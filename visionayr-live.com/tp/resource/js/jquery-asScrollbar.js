(function($){
	...
	var AsScrollable = $.AsScrollable = function( options, container){
		var oriAttr,
		self = this,
		$container = this.$container = $(container),
		options = this.options = $.extend(this.options,$.AsScrollable.defaults,options||{});
	...
	var defaults = $.AsScrollable.defaults = {
	...
	$.fn.asScrollable = function(options){
		if(typeof options === 'string'){
			...
			this.each(function(){
				if( ! $(this).data('scroll')){
					$(this).data('scroll',new $.AsScrollable(options,this));
				}
			});
